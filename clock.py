...
clk = Tk()
clk.title("clock")
clk.geometry("1350x700+0+0") #width, height, x-axis,y-axis we have kept 0 becuase we will start from left top corner
clk.config(bg = "#0C1E28")#you can give nay color you want
